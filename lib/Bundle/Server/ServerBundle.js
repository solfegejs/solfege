...
var ServerBundle = (function (_super) {
    ...
    ServerBundle.prototype.initializeConsoleCommands = function () {
        var command;
        ...
        _super.prototype.initializeConsoleCommands.call(this);
    };

    ServerBundle.prototype.startServer = function (environment) {
    ...
    ServerBundle.prototype.getDaemon = function () {
        ...
        var applicationEnvironment = this.environment;
