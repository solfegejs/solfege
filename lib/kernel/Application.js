    ...
    start() {
        ...
        (0, _co2.default)(function* () {
            ...
            if (typeof self.configurationFilePath === "string") {
                ...
                var configurationFileContent = yield _coFs2.default.readFile(self.configurationFilePath, 'utf8');
                var configuration = _jsYaml2.default.safeLoad(configurationFileContent);
