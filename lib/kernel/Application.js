...
var _errorErrorChain = require("../error/ErrorChain");

var _errorErrorChain2 = _interopRequireDefault(_errorErrorChain);
                ...
                try {
                    for (var _iterator = self.bundles.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        try {
                            ...
                            throw new _errorErrorChain2["default"](error, "Bundle \"" + bundleId + "\" failed");
                        }
                    }
                } catch (err) {
